...
import SourceCitationBanner from '../../components/ui/SourceCitationBanner';
                ...
                <ScrollView style={styles.contentContainer} contentContainerStyle={styles.contentPadding}>
                    ...
                    {activeTab === 'conditions' && (
                        <View style={styles.section}>
                            ...
                            <SourceCitationBanner
                                text="Medical conditions are classified using the WHO International Classification of Diseases (ICD-11). Condition-specific nutrition profiles are generated by AI based on clinical guidelines."
                                sources={[
                                    { label: 'WHO ICD-11', url: 'https://icd.who.int/' },
                                ]}
                            />
                        </View>
                    )}
                    ...
                    {activeTab === 'medical' && (
                        <View style={styles.section}>
                            ...
                            <SourceCitationBanner
                                text="Medication data sourced from the U.S. National Library of Medicine RxNorm database and FDA drug labels."
                                sources={[
                                    { label: 'NLM RxNorm', url: 'https://www.nlm.nih.gov/research/umls/rxnorm/' },
                                    { label: 'FDA Drug Labels', url: 'https://labels.fda.gov/' },
                                ]}
                            />
                        </View>
                    )}
                        ...
                        >
                            <View style={styles.section}>
                                ...
                                <View style={[styles.card, { backgroundColor: theme.card, borderColor: theme.border }]}>
                                    ...
                                    <SourceCitationBanner
                                        text="Nutrition limits are personalized by AI based on established clinical nutrition guidelines. Always verify with your healthcare provider."
                                        sources={[
                                            { label: 'KDOQI Guidelines', url: 'https://www.kidney.org/professionals/guidelines' },
                                            { label: 'ADA Standards', url: 'https://diabetes.org/about-diabetes/treatment-care/standards-of-care' },
                                        ...
                                        disclaimer="This app does not replace professional medical advice. Consult your physician or registered dietitian before making dietary changes."
                                    />
                                </View>
                            </View>
                        </ProGate>
                    ...
                    {activeTab === 'settings' && (
                        <View style={styles.section}>
                            ...
                            <Text style={[styles.sectionTitle, { color: theme.text, marginTop: 24 }]}>Sources & Disclaimers</Text>
                            <View style={[styles.card, { backgroundColor: theme.card, borderColor: theme.border }]}>
                                <Text style={{ fontSize: 13, color: theme.textMuted, lineHeight: 20, marginBottom: 12 }}>
                                    NutriPioneer uses data from the following trusted sources. Tap any link to learn more.
                                </Text>
                                ...
                                <View style={{ marginTop: 16, paddingTop: 12, borderTopWidth: 1, borderTopColor: theme.border }}>
                                    <Text style={{ fontSize: 12, color: theme.textMuted, fontStyle: 'italic', lineHeight: 18 }}>
                                        Disclaimer: NutriPioneer provides general nutritional information and AI-generated recommendations based on established clinical guidelines. This app is not a substitute for professional medical advice, diagnosis, or treatment. Always consult your physician or registered dietitian before making dietary changes.
                                    </Text>
                                </View>
                            </View>
                        </View>
