    ...
    return (
        <ScrollView style={styles.resultsContainer} contentContainerStyle={{ paddingBottom: 40 }}>
            ...
            <SourceCitationBanner
                text="Menu analysis is AI-generated using your health profile and clinical nutrition guidelines for your conditions. Results may not account for all ingredients or cooking methods."
                sources={[
                ...
                disclaimer="Always confirm ingredients and preparation methods with restaurant staff, especially for severe allergies or medical conditions. This does not constitute medical advice."
            />
        </ScrollView>
    );
};
...
export default function RestaurantRescueScreen() {
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
            ...
            <Text style={{ textAlign: 'center', marginVertical: 16, paddingHorizontal: 16, fontSize: 12, color: theme.textMuted }}>
                Analysis powered by AI based on clinical nutrition guidelines. Not a substitute for professional medical advice.
            </Text>
        </SafeAreaView>
    );
}
