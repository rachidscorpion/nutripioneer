            ...
            <View style={styles.backdrop}>
                <View style={[styles.modalContent, { marginTop: insets.top + 20, marginBottom: insets.bottom + 20 }]}>
                    ...
                    <SourceCitationBanner
                        text="Nutritional data sourced from USDA FoodData Central, FatSecret, and Open Food Facts databases. Bioavailability analysis is AI-generated based on clinical nutrition guidelines."
                        sources={[
                            { label: 'USDA FoodData Central', url: 'https://fdc.nal.usda.gov/' },
                            { label: 'Open Food Facts', url: 'https://world.openfoodfacts.org/' },
                            { label: 'FatSecret', url: 'https://www.fatsecret.com/' },
                        ]}
                        disclaimer="This analysis is for informational purposes only and does not constitute medical advice. Consult your healthcare provider."
                    />
                    </ProGate>
                </View>
            </View>
