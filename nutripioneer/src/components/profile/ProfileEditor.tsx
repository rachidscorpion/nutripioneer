                                    ...
                                    <div style={{ display: 'flex', gap: '12px' }}>
                                        ...
                                        <div>
                                            ...
                                            <p style={{ fontSize: '0.85rem', color: 'var(--muted-foreground)', lineHeight: '1.4' }}>
                                                Got nutrition limits from your physician? You can update them here. Any updates here will be used by our AI to ensure your meal plans are safe.
                                                <br /><br />
                                                <strong>Disclaimer:</strong> These limits are initially generated by AI. They can be edited based on your dieting or physician's recommendations.
                                            </p>
                                        </div>
                                    </div>
                                </div>
