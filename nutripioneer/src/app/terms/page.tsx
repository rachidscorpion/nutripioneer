  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.contentWrapper}>
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>6. AI Disclaimer & Data Sharing</h2>
          <p className={styles.text}>
            NutriPioneer utilizes third-party Artificial Intelligence (AI) services, specifically <strong>OpenAI</strong>, for various features including nutrition analysis, food scanning, and plan generation. 
            By creating an account and consenting during the onboarding process, you grant us permission to send your biometric, medical, and dietary data to OpenAI. 
            We confirm that OpenAI provides equal protection of your data, and explicitly does not use data submitted via its API to train its models. 
            These analyses and results generated by AI may not be 100% accurate. AI-generated nutrition limits and recommendations can be edited based on your diet or physician's recommendations.
          </p>
        </section>
      </main>
